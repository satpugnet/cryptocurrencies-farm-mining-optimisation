...
public class CoinWarzCurrencyInformationRetriever implements CurrencyInformationRetriever {
    ...
    @Override
    public double getBlockReward(AllCurrenciesShortNames currentCurrencyShortNames) {
        double blockReward = findInformationInData(currentCurrencyShortNames.toString(), "Difficulty");
        logger.info("Getting a blockReward for " + currentCurrencyShortNames + " of " + blockReward);
        return blockReward;
    }
